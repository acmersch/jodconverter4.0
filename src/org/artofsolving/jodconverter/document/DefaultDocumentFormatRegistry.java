...
public class DefaultDocumentFormatRegistry extends SimpleDocumentFormatRegistry {
	...
	public DefaultDocumentFormatRegistry() {
		...
		DocumentFormat vsd = new DocumentFormat(" Microsoft Visio", "vsd", "application/visio");
		vsd.setInputFamily(DocumentFamily.DRAWING);
		vsd.setStoreProperties(DocumentFamily.DRAWING, Collections.singletonMap("FilterName", "visio"));
		addFormat(vsd);
